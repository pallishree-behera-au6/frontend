  ...
  return (
    <>
      ...
      <nav class="mb-4 navbar navbar-expand-lg navbar-dark red darken-2">
        <a class="navbar-brand font-bold mob_75" href="#">
        ...
        <div class="collapse navbar-collapse" id="navbarText1">
          ...
          <div class="col-md-3">
            <div class="social-media-number">
              ...
              {/* <a href="#" class="fa social_media">
                <img src="https://img.icons8.com/ios-glyphs/28/ffffff/open-book--v1.png" />
              </a> */}
              ...
              <div class="row">
                ...
                <div class="col-md-9 col-sm-12 col-xs-3">
                  <div class="dropdown">
                    ...
                    >
                      <img src="https://img.icons8.com/material-rounded/32/ffffff/settings.png" />
